...
tc.assertListEqual( sorted(list(molecule.bond_keys)), sorted(list(gly_expected)), "gly lists not equal" ) 
...
tc = unittest.TestCase()
tc.assertListEqual( sorted(list(molecule.bond_keys)), sorted(list(ala_expected)), "ala lists not equal" ) 
...
tc = unittest.TestCase()
tc.assertListEqual( sorted(list(molecule.bond_keys)), sorted(list(arg_expected)), "arginine lists not equal" ) 
...
phe_expected = ['[C][OH]', '[=O][C]', '[C][C]', '[C][NH2]', '[C][C]', '[C1][C]',
       ...
       '[C5][C6]']
tc = unittest.TestCase()
tc.assertListEqual( sorted(list(molecule.bond_keys)), sorted(list(phe_expected)), "phenylalanine lists not equal" ) 
...
tyr_expected = ['[C][OH]', '[=O][C]', '[C][C]', '[C][NH2]', '[C][C]', '[C1][C]',
       ...
       '[C4][C5]', '[C5][C6]']
tc = unittest.TestCase()
tc.assertListEqual( sorted(list(molecule.bond_keys)), sorted(list(tyr_expected)), "tyrosine lists not equal" ) 
...
tc = unittest.TestCase()
tc.assertListEqual( sorted( list(molecule.bond_keys) ), sorted( list(CH3_expected) ), "CH3 case 0 lists not equal" ) 
...
tc = unittest.TestCase()
tc.assertListEqual( sorted( list(molecule.bond_keys) ), sorted( list(CH3_expected) ), "CH3 case 1 lists not equal" ) 

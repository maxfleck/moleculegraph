...
mdma_expected = ['[C][CH3]', '[C][HN]', '[C][C]', '[CH3][HN]', '[C1][C]',
       '[C1][C2]', '[C1][C6]', '[C2][C3]', '[C3][C4]', '[C3][O2]',
       '[C4][O1]', '[C4][C5]', '[C][O1]', '[C][O2]', '[C5][C6]']

tc = unittest.TestCase()
tc.assertListEqual( sorted(list(molecule.bond_keys)), sorted(list(mdma_expected)), "lists not equal" ) 
...
keta_expected = ['[CH3][NH]', '[C1][NH]', '[C1][C2]', '[C1][C6]', '[C1][CC1]',
       '[=O][C2]', '[C2][C3]', '[C3][C4]', '[C4][C5]', '[C5][C6]',
       '[CC1][CC2]', '[CC1][CC6]', '[CC2][Cl]', '[CC2][CC3]',
       '[CC3][CC4]', '[CC4][CC5]', '[CC5][CC6]']

tc = unittest.TestCase()
tc.assertListEqual( sorted(list(molecule.bond_keys)), sorted(list(keta_expected)), "lists not equal" ) 
...
mut_keta_expected = ['[CH3][NH]', '[C1][NH]', '[C1][C2]', '[C1][C6]', '[C1][CC1]',
       '[=O][C2]', '[C2][C3]', '[C3][C4]', '[C4][C5]', '[C5][C6]',
       '[=O][C6]', '[CC1][CC2]']

tc = unittest.TestCase()
tc.assertListEqual( sorted(list(molecule.bond_keys)), sorted(list(mut_keta_expected)), "lists not equal" ) 
...
lllong_expected = ['[C1][C2]', '[C1][C6]', '[C1][C]', '[C1][C]', '[C2][C3]', '[C3][C4]',
                   '[C4][C5]', '[C5][C6]', '[CC1][CC2]', '[CC1][C]', '[CH3][NH]', '[C][NH]']

tc = unittest.TestCase()
tc.assertListEqual( sorted(list(molecule.bond_keys)), sorted(list(lllong_expected)), "lists not equal" ) 
...
tc = unittest.TestCase()
tc.assertListEqual( sorted(list(molecule.bond_keys)), sorted(list(lllong_expected2)), "lists not equal" ) 
